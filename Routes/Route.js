  ...
  return (
    <Tab.Navigator
          ...
          if (route.name === "Herd") {
            ...
            return (
              <Image
                ...
                resizeMode="center"
                style={{ width: "28%", height: "100%", resizeMode: "contain" }} // Adjust the size as needed
              />
            );
          }

          // Increase font size and icon size when focused
          if (focused) {
            iconSize += 10; // Increase icon size
            labelStyle = { fontSize: 30, fontWeight: "bold" }; // Increase font size and add bold
          }
      ...
      tabBarOptions={{
        ...
        activeTintColor: "purple", // Set text color for the active tab
        inactiveTintColor: "white", // Set text color for the inactive tab
      }}
    >
      <Tab.Screen
        name="Herd"
